...
public class ReminderController {
	...
	public ResponseEntity<?> getReminderDetails(@PathVariable("reminderId") int reminderId) {
		try {
			Reminder search = reminderService.getReminder(reminderId);
			return new ResponseEntity<Reminder>(search,HttpStatus.OK);
	...
	public ResponseEntity<?> addReminder(@RequestBody() Reminder reminder) {
		try {
			...
			return new ResponseEntity<Reminder>(addedReminder,HttpStatus.CREATED);
		} catch (Exception e) {
			return new ResponseEntity<String>(e.getMessage(),HttpStatus.NOT_FOUND);
		}
	}
	...
	public ResponseEntity<?> updateReminderDetails(@PathVariable("reminderId") int reminderId) {
		try {
			Reminder search = reminderService.getReminder(reminderId);
			Reminder updatedReminder = reminderService.updateReminder(search);
	...
	public ResponseEntity<?> deleteReminderDetails(@PathVariable("reminderId") int reminderId) {
		try {
