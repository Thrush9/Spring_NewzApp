...
public class NewsController {
	 ...
	 */
	@GetMapping
	public ResponseEntity<?> getNewsDetails(){
	 ...
	 */
	@GetMapping("/{newsId}")
	public ResponseEntity<?> getNewsDetails(@PathVariable("newsId") int newsId){
		try {
			News search = newsService.getNews(newsId);
			return new ResponseEntity<News>(search,HttpStatus.OK);
	 ...
	 */
	@PostMapping()
	public ResponseEntity<?> addNewsDetails(@RequestBody() News news){
		try {
			News addedNews = newsService.addNews(news);
			return new ResponseEntity<News>(addedNews,HttpStatus.CREATED);
	 ...
	 */
	@PutMapping("/{newsId}")
	public ResponseEntity<?> updateNewsDetails(@PathVariable("newsId") int newsId){
		try {
			News search = newsService.getNews(newsId);
			News updatedNews = newsService.updateNews(search);
	...
	public ResponseEntity<?> deleteNewsDetails(@PathVariable("newsId") int newsId){
		try {
